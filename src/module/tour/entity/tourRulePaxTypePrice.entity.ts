...
export class TourRulePaxTypePriceEntity {
    ...
    @ManyToOne(() => TourPriceRuleEntity, (tour_price_rule) => tour_price_rule.tour_rule_pax_type_prices, { 
        nullable: false,
        onDelete: 'CASCADE',
    })
    ...
    @ManyToOne(() => TourPaxTypeEntity, (pax_type) => pax_type.tour_variant_pax_type_prices, { 
        nullable: false,
        onDelete: 'CASCADE',
    })
