...
export class AdminArticleController {
    constructor(private readonly adminArticleServiceProxy: AdminArticleServiceProxy) { }
    ...
    async getArticles(
        ...
        return this.adminArticleServiceProxy.getArticles(limit, page, { search, is_visible });
    }
